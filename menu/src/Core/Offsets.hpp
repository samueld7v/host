...
namespace Core {
    ...
    public:
        ...
        uintptr_t m_SilentAim,
            ...
            m_CopyVariation,
            m_SetInSpectatorMode,
            m_IsInSpectatorMode,
            m_SetVehicleForwardSpeed,
            m_PointerToHandle,
            m_GiveWeapon,
            m_SoloSessionStart,
            m_SoloSessionEnd,
        ...
        // Player name reading (scan pattern)
        uintptr_t m_PlayerNamePtr;

        // SyncTree / Crash Exploit
        uintptr_t m_OffsetPool;
